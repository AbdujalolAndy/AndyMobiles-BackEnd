...
//Blog related enums
exports.blog_category_enums = ["CELEBRITY", "EVALUATION", "STORY", "ABOUTUS"];
exports.blog_status_enums = ["DELETED", "ACTIVE"];

//Order related enums
exports.order_status_enums = ["PAUSED", "PROCESS", "FINISHED", "CANCELED"];

//Like related enums
exports.like_group_enums = ["product", "member", "community"];
